    ...
    listGroupTodo.innerHTML += `
      ...
      item.completed == true ? 'complated' : ''
        ...
        <div class="todo-icons">
          ...
          <img onclick="editTodo(${i})" src="img/edit.svg" width="25" height="25" alt="edit" />
          <img onclick="deleteTodo(${i})" src="img/delete.svg" width="25" height="25" alt="delete" />
        </div>
       </li>
       `
  })
...
formCreate.addEventListener('submit', (e) => {
  ...
  const todoText = document.getElementById('input-create').value.trim()
  formCreate.reset()
  if (todoText.length) {
    todos.push({
      text: todoText,
...
formEdit.addEventListener('submit', (e) => {
  ...
  const todoText = document.getElementById('input-edit').value.trim()
  formEdit.reset()
  if (todoText.length) {
